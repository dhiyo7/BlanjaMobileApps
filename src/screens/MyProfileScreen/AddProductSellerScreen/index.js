...
const AddProduct = ({ navigation }) => {
  ...
  const handleSubmit = () => {
    ...
    console.log(formatDataSizeToSend(size))
    console.log(formatDataColorToSend(color))
  ...
  /*const handleSubmit = async () => {
    ...
    data.append('sizes', formatDataToSend(size))
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={{ flexDirection: 'row' }}>
        <TouchableOpacity onPress={pickCamera} style={styles.button}>
          ...
          {
            size.map(s => {
              return s.is_selected ? <Text key={s.id.toString()}>{s.size}</Text> : null
            })
          }
        </TouchableOpacity>
      </View>
          ...
          <View style={{ justifyContent: 'center' }}>
            <View style={{ justifyContent: 'center' }}>
              ...
              {color.map(({ id, color_name }) => {
                return (
                  <View key={id.toString()} style={shouldColorCheckedOnStyle(id)}>
                    <TouchableOpacity onPress={() => addOrRemoveColorSelected(id)}>
